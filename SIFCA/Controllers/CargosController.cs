...
namespace SIFCA.Controllers
{
    public class CargosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CODCRG,DESCPR,USRCRE,FCHCRE,USRACT,FCHACT")] Cargos cargos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CODCRG,DESCPR,USRCRE,FCHCRE,USRACT,FCHACT")] Cargos cargos)
        {
            if (ModelState.IsValid)
            {
